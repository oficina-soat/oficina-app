...
public class AprovarOrdemDeServicoUseCase {

    private final TransicaoDeEstadoDaOrdemDeServicoService transicaoDeEstadoDaOrdemDeServicoService;

    public AprovarOrdemDeServicoUseCase(TransicaoDeEstadoDaOrdemDeServicoService transicaoDeEstadoDaOrdemDeServicoService) {
